...
public class BasicDocument extends Document 
{
	...
	public int getNumWords()
	{
		...
		return (wholeText.split("[^a-zA-Z]+")).length;
	}
	...
	public int getNumSyllables()
	{
		...
		if (wholeText == "") return 0;
		int total = 0;
		// first split to get array of words
		for (String s : wholeText.split("[^a-zA-Z]+")) {
			
			// for each word add number of syllables to total 
	...
	public static void main(String[] args)
	{
		 ...
		 */
		Document testD = new BasicDocument("This is a test.  How many???  "
		...
		System.out.println(testD.getFleschScore());
